# Glucosio Individual Contributor License Agreement

Thank you for your interest in contributing to Glucosio (“We” or “Us”).
...
You grant us additional permission to convey this Program, or any covered work through any distribution channel we choose (i.e. Apple App Store, Google Play Store, F-Droid, Amazon App Store etc) and waive any right to challenge such distribution.

In addition, We may use the following licenses for Media in the Contribution: http://www.glucosio.org/media-licensing (including any right to adopt any future version of a license if permitted).
...
## 6. Miscellaneous
6.1 This Agreement will be governed by and construed in accordance with the laws of Oregon excluding its conflicts of law provisions. Under certain circumstances, the governing law in this section might be superseded by the United Nations Convention on Contracts for the International Sale of Goods (“UN Convention”) and the parties intend to avoid the application of the UN Convention to this Agreement and, thus, exclude the application of the UN Convention in its entirety to this Agreement.
